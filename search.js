    ...
    if (initialized_session == 'true') {
        ...
        fetch('http://localhost:3000/getAllCargas', {
            ...
            .then(data => {
                ...
                data.forEach(res => {
                    let today = new Date(),
                        date_origen_carga = new Date(res.fec_retiro);

                    //Para que no muestre cargas vencidas
                    if (today < date_origen_carga) {

                        if (res.cod_estado_carga != 3 && res.cod_estado_carga != 4 && res.cod_estado_carga != 5 && res.cod_estado_carga != 6) {
                    ...
                    .then(data => {
                        ...
                        data.forEach(res => {
                            ...
                            if (today < date_origen_carga) {
                                ...
                                p.innerHTML = `<b>Cantidad de Cargas encontradas: ${cant}</b>`;
