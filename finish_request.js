        ...
        .then(data => {
            ...
            switch (data[0].estado) {
                ...
                case "in_process":
                    ...
                    mjs_confirmacion.innerHTML = "¡No puede aceptar la solicitud. Su pago esta en estado 'Pendiente de pago'! </br> Cuando se acredite aceptaremos la solicitud."
            ...
            fetch(`http://localhost:3000/getOneCargaUser/${cod_carga}`, {
                ...
                .then(data => {
                    ...
                    fetch(`http://localhost:3000/dashboard/${data[0].cod_usuario}`, {
                        ...
                        .then(data => {
                            //console.log(data);
                            window.location.href = `./dashboard.html?cod_usuario=${data[0].cod_usuario}&tpo_usuario=${data[0].tipo_usuario}`;
                        })
                })
        })
        // }
