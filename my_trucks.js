...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    const getURL = new URLSearchParams(window.location.search),
        ...
        tableBodyCamion = document.querySelector(".t_body_camion"),
        ...
        fetch(`http://localhost:3000/getTrucksUser/${cod_usuario}`, {
            ...
            .then(data => {
                ...
                data.forEach(res => {
                    ...
                    if (res.eliminado == false || res.eliminado == null) {
                        ...
                        btnDeleteCamion.addEventListener("click", (event) => {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    let deleteCamion = { patente_camion: res.patente_camion, eliminado: true };

                                    fetch(`http://localhost:3000/logicDeleteTruck/`, {
                                            method: 'PUT',
                                            headers: {
                                                "Content-Type": "application/json"
                                            },
                                            body: JSON.stringify(deleteCamion)
                                        }).then(data => {
                                            console.log(data);
                                        })
                                        .catch(err => { console.log(err); })
                        ...
                        btnDeleteCarroceria.addEventListener("click", (event) => {
                            ...
                            Swal.fire({
                                ...
                                .then((result) => {
                                    ...
                                    if (result.isConfirmed) {
                                        let deleteCarroceria = { patente_carroceria: res.patente_carroceria, eliminado: true };

                                        fetch(`http://localhost:3000/logicDeleteCarroceria/`, {
                                                method: 'PUT',
                                                headers: {
                                                    "Content-Type": "application/json"
                                                },
                                                body: JSON.stringify(deleteCarroceria)
                                            }).then(data => {
                                                console.log(data);
                                            })
                                            .catch(err => { console.log(err); })
